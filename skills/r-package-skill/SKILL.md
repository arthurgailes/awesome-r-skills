...
skills/r-{package}/
  ...
  references/
    manual.md           # REQUIRED: Full function reference
    vignette-name.md    # Optional: Full vignettes
    advanced.md         # Optional: Advanced patterns
```

**REQUIRED:** `references/manual.md` with complete function documentation.
...
- Function signatures → `references/manual.md`
...
3. **REQUIRED:** Extract full function reference to `references/manual.md`
...
| Not creating `references/manual.md` | REQUIRED for every package skill |
| SKILL.md >500 words | Move content to `references/` |
| Function signatures in SKILL.md | All go in `references/manual.md` |
...
- **Not creating `references/manual.md`**
